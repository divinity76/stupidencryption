...
//1000C57377FE3545A8D68AE30E378D1AF594
//100086CCA484E700215BCCC5F4B3CA33C37E
$encrypted_string=base64_encode(pack("H*","C57377FE3545A8D68AE30E378D1AF594"));
$encrypted_string2=base64_encode(pack("H*","86CCA484E700215BCCC5F4B3CA33C37E"))
...
$dll_key2=pack("H*","2037EFC675AF8B45CC8B55DC89748202");
$dll_key3=pack("H*","2037EFC68945CC89D7C1EF0B83E7038B");
$keys=[$exe_key,$dll_key1,$dll_key2,$dll_key3];


foreach($keys as $key){
echo 'START';
$xtea = new XTEA($key);
	$cipher =$encrypted_string;// $xtea->Encrypt("Hello Worldd"); //Encrypts 'Hello World'
	//die(var_dump($cipher));
